...
return array(
	...
	'Alidayu_APP_KEY'=> '23401578',
	'Alidayu_APP_SECRET'=> 'e80e1312fdbcf74ae7b41e93a4312796',

	'app_ui'=> '/statics/taosf/',
	'wap_ui'=> '/statics/wap/', 
	//支付宝配置参数
	'alipay_config'=>array(
		'partner' =>'2088421264539813',   //这里是你在成功申请支付宝接口后获取到的PID；
		'key'=>'kzjlvhs3a4jgsm08fmnjgt0ggmp9b2pr',//这里是你在成功申请支付宝接口后获取到的Key
	...
	'alipay'   =>array(
		...
		'seller_email'=>'ruianxingye888@126.com',
		//这里是异步通知页面url，提交到项目的Pay控制器的notifyurl方法；
		'notify_url'=>'http://www.taoshenfang.com/index.php?g=Member&m=User&a=yhq',
		//这里是页面跳转通知url，提交到项目的Pay控制器的returnurl方法；
		'return_url'=>'http://www.taoshenfang.com/index.php?g=Member&m=User&a=yhq',
		//支付成功跳转到的页面，我这里跳转到项目的User控制器，myorder方法，并传参payed（已支付列表）
		'successpage'=>'index.php?g=Member&m=User&a=yhq',
		//支付失败跳转到的页面，我这里跳转到项目的User控制器，myorder方法，并传参unpay（未支付列表）
		'errorpage'=>'index.php?g=Member&m=User&a=yhq',
	),	
);
