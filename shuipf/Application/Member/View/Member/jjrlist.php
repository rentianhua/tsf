...
<div class="wrap J_check_wrap">
  ...
  <form name="searchform" action="" method="get" >
    ...
    <input type="hidden" value="jjrlist" name="a">
  ...
  <form name="myform" action="{:U('Member/delete')}" method="post" class="J_ajaxForm">
          ...
          <volist name="data" id="vo">
            <tr>
              ...
              <img src="
                ...
                &nbsp;&nbsp;
                <if condition="$vo['agent']['jiav'] eq 1">
                <img src="/statics/taosf/images/v.png" alt="">
                </if>                
                </td>
    ...
    <div class="">
      <div class="btn_wrap_pd">
        ...
        <a class="btn" href="{:U('Member/Member/jjrdata')}">导出数据</a>
      </div>
    </div>
  </form>
</div>
...
function applyvtel(vtel, uid){
	...
	var obj = jQuery.parseJSON(data);
      if(obj.success == 57){
       window.parent.document.getElementById('iframe_207Member').contentWindow.location.reload(true);
