    ...
    <div class="search_type cc mb10">
      <div class="mb10"> <span class="mr20"> 注册时间：
        ...
        <select name="type">
          ...
          <option value='2' <if condition="$_GET.type eq '2' "> selected</if>>用户ID</option>
          <option value='4' <if condition="$_GET.type eq '4' "> selected</if>>注册ip</option>
          <option value='5' <if condition="$_GET.type eq '5' "> selected</if>>姓名</option>
        </select>
