...
<div class="wrap J_check_wrap">
  <a style="margin-left:15px;" href="/index.php?g=Member&m=Member&a=jjrlist&menuid=207">< 返回经纪人列表</a>
  <div style="margin-left:15px;font-weight: bold;font-size: 18px">
  当前用户：{$uname}&nbsp;/ 经纪人</div>
  <div class="nav">
    <ul class="cc">
        <li <if condition="(!$t) OR ($t eq 1)">class="current"</if>><a href="{:U('Member/jjrcenter', array('t'=>1,'userid'=>$uid,'username'=>$uname) )}">发布的二手房</a></li>
        <li <if condition="$t eq 2">class="current"</if>><a href="{:U('Member/jjrcenter', array('t'=>2,'userid'=>$uid,'username'=>$uname) )}">发布的出租房</a></li>
        <li <if condition="$t eq 3">class="current"</if>><a href="{:U('Member/jjrcenter', array('t'=>3,'userid'=>$uid,'username'=>$uname) )}">成交房源</a></li>
        <li <if condition="$t eq 4">class="current"</if>><a href="{:U('Member/jjrcenter', array('t'=>4,'userid'=>$uid,'username'=>$uname) )}">预约管理</a></li>
        <li <if condition="$t eq 5">class="current"</if>><a href="{:U('Member/jjrcenter', array('t'=>5,'userid'=>$uid,'username'=>$uname) )}">求租管理</a></li>
        <li <if condition="$t eq 7">class="current"</if>><a href="{:U('Member/jjrcenter', array('t'=>7,'userid'=>$uid,'username'=>$uname) )}">优惠券订单</a></li>
        <li <if condition="$t eq 8">class="current"</if>><a href="{:U('Member/jjrcenter', array('t'=>8,'userid'=>$uid,'username'=>$uname) )}">勾地订单</a></li>
        <li <if condition="$t eq 9">class="current"</if>><a href="{:U('Member/jjrcenter', array('t'=>9,'userid'=>$uid,'username'=>$uname) )}">历史记录</a></li>
      </ul>
</div>
  <form name="myform" action="{:U('Member/delete')}" method="post" class="J_ajaxForm">
    <div class="table_list">
      <table width="100%" cellspacing="0">
      <if condition="(!$t) OR ($t eq 1)">
        <thead>
          <tr>
            <td align="left">ID</td>
