...
class IndexController extends MemberbaseController {
    ...
    public function login() {
        ...
        if (!empty($this->userid)) {
			$this->redirect($forward ? $forward : 'Index/home');
    ...
    public function uploadavatar() {
        ...
        //上传结束
		$user_id = $this->userid;
		$model_id = M('member')->where('userid='.$user_id)->getfield('modelid');
		$u['userpic'] ="http://www.taoshenfang.com/d/file/avatar/000/00/00/".$this->userid."_180x180.jpg";
		M('member')->where('userid='.$this->userid)->save($u);
        exit(json_encode(array(
            'success' => true,
