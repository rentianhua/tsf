    ...
    <form method='post'   id="myform" class="J_ajaxForm"  action="{:U('Config/index')}">
      ...
      <tr>
	     ...
	     <td><input type="text" class="input"  name="siteemail" value="{$Site.siteemail}" size="40"> </td>
            ...
            <tr>
	     <th width="140">客服热线:</th>
	     <td><input type="text" class="input"  name="hottel" value="{$Site.hottel}" size="40"> </td>
      </tr>
            <tr>
	     <th width="140">工作时间:</th>
	     <td><input type="text" class="input"  name="worktime" value="{$Site.worktime}" size="40"> </td>
      </tr>

                  <tr>
	     <th width="140">400电话:</th>
	     <td><input type="text" class="input"  name="tel400" value="{$Site.tel400}" size="40"> </td>
      </tr>
                  <tr>
	     <th width="140">QQ客服:</th>
	     <td><textarea name="qq" style="width:380px; height:120px;">{$Site.qq}</textarea><span class="gray"> 注意格式 "123456789|客服" 一行一个客服 最多五个</span></td>
      </tr>  
      <tr>
	     <th width="140">首页主标题:</th>
	     <td><input type="text" class="input"  name="zhubiaoti" value="{$Site.zhubiaoti}" size="40"> </td>
      </tr>
            <tr>
	     <th width="140">首页副标题:</th>
	     <td><input type="text" class="input"  name="fubiaoti" value="{$Site.fubiaoti}" size="40"> </td>
      </tr>  
      <tr>
	     <th width="140">首页二手房推荐简介:</th>
	     <td><input type="text" class="input"  name="ershou_desc" value="{$Site.ershou_desc}" size="140"> </td>
      </tr>
      <tr>
	     <th width="140">首页新房推荐简介:</th>
	     <td><input type="text" class="input"  name="new_desc" value="{$Site.new_desc}" size="140"> </td>
      </tr>
      <tr>
	     <th width="140">首页租房推荐简介:</th>
	     <td><input type="text" class="input"  name="chuzu_desc" value="{$Site.chuzu_desc}" size="140"> </td>
      </tr>        
      <tr>
	     <th width="140">网站关键字:</th>
	     <td><input type="text" class="input"  name="sitekeywords" value="{$Site.sitekeywords}" size="140"> </td>
      </tr>
      <tr>
