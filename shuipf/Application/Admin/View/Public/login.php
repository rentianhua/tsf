...
.header h1{background-repeat:no-repeat;width:227px;height:78px;line-height:150px;overflow:hidden;font-size:0}
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright &copy;{:date('Y')} , Taoshenfang All Rights Reserved.</p>
      <p class="copyright_ch"><a href="http://www.taoshenfang.com" target="_blank">http://www.taoshenfang.com</a></p>
    </div>
  </div>
</div>
