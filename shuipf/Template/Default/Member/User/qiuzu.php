...
<div class="user-main">
  ...
  <if condition="$userinfo['modelid'] eq 35">
  	<a class="am-btn am-btn-primary" href="/index.php?m=qiuzu&a=add">我要发布</a>
    </if>
    <table class="am-table">
			...
			$list=M('userqiuzu')->where($u)->order('inputtime DESC')->select();
			?>
            ...
            <tr>
                  ...
                  <th>{$vo.username}</th>
                	...
                	<a href="javascript:;" value="/index.php?m=qiuzu&a=del&id={$vo.id}" class="del">
