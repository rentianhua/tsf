...
<div class="user-main">
  ...
  <div class="main-right fr" id="allList">
    <div class="tab">
    <a href="/index.php?g=Member&m=User&a=weituo&t=1">
    <span class="actTap <if condition="$_GET['t'] eq 1">hover selected</if>">二手房</span>
    </a>
    <a href="/index.php?g=Member&m=User&a=weituo&t=2">
    ...
    <div id="ershoufang" style="display: block;" class="all-list selected fav-list">
      ...
      <if condition="$_GET['t'] eq 1">
        <li>
          ...
          <a style="right:100px;" href="/index.php?m=Esf&a=edit&id={$vo.id}&t=1" class="del-fav actDelFollow">编辑</a>
          ...
          <if condition="$vo['status'] eq 99">
			  <if condition="$vo['zaishou'] eq 1">
				  ...
				  <else/>
				  <a href="javascript:apply_shouchu('{$vo.id}','ershou');" class="am-btn am-btn-xs am-btn-default">申请已售出</a>
				  </if>
			 <else/>
      ...
      <else />
          ...
          <a style="right:100px;" href="/index.php?m=Czf&a=edit&id={$vo.id}&t=1" class="del-fav actDelFollow">编辑</a>
          ...
          <if condition="$vo['status'] eq 99">
			  <if condition="$vo['zaizu'] eq 1">
				  ...
				  <else/>
				  <a href="javascript:apply_shouchu('{$vo.id}','chuzu');" class="am-btn am-btn-xs am-btn-default">申请已出租</a>
				  </if>
			 <else/>
      ...
      <div id="idcard_con">
       <div>
        ...
        <input value="1" name="idcard" type="hidden">
          ...
          <div class="bk10"></div>
          <a class="btn am-btn am-btn-danger am-round" onclick="javascript:flashupload1('pics_images', '图片上传','idcard',change_images,'10,gif|jpg|jpeg|png|bmp,1,,,0','Content','6')" herf="javascript:void(0);"><span class="add"></span>选择图片 </a> <span></span>
...
function apply_shouchu(id,biao){	
	$.ajax({
