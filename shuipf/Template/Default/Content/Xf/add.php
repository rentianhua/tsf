...
<div class="w-content am-text-lg" style="border: 1px solid #F2F2F2;">
  ...
  <form class="w-form" action="" method="post">
    ...
    <div>
      ...
      <input id="jingweidu" name="jingweidu" type="text" style="width:300px;">
    ...
    <div>
      ...
      <select name="wuyeleixing" data-am-selected>
        ...
        <option value="集体用地村委统建楼">集体用地村委统建楼</option>
        <option value="集体用地开发商自建楼">集体用地开发商自建楼</option>
        <option value="集体用地个人自建房">集体用地个人自建房</option>
        <option value="军区建房">军区建房</option>
        <option value="武警部队建房">武警部队建房</option>
        <option value="工业属性长租物业">工业属性长租物业</option>
        <option value="工业可分割产权物业">工业可分割产权物业</option>
        <option value="其他">其他</option>
      </select>
    </div>
    <div>
      <span class="w-head">物业公司：</span>
      <input id="wuyegongsi" name="wuyegongsi" type="text" style="width:300px;">
      <span id="mwuyegongsi"></span>
    </div>
    <div>
      <span class="w-head">物业费：</span>
      <input id="wuyefei" name="wuyefei" type="text" style="width:300px;"> 元/㎡
      <span id="mwuyefei"></span>
    </div>
    <div>
      <span class="w-head">规划户数：</span>
      <input id="guihuahushu" name="guihuahushu" type="text" style="width:300px;"> 户
      <span id="mguihuahushu"></span>
    </div>
    <div>
      <span class="w-head">规划车位：</span>
      <input id="guihuachewei" name="guihuachewei" type="text" style="width:300px;"> 个
    ...
    <div>
      ...
      <select name="jianzhuleixing" data-am-selected>
        ...
        <option value="中高层">中高层</option>
        <option value="高层">高层</option>
      </select>
    </div>
    <div>
      <span class="w-head">水电燃气：</span>
      <select name="shuidianranqi" data-am-selected>
        <option value="民用水电" selected>民用水电</option>
        <option value="商用水电">商用水电</option>
        <option value="其他">其他</option>
      </select>
    </div>
    <div>
      <span class="w-head">容积率：</span>
      <input id="rongjilv" name="rongjilv" type="text" style="width:300px;"> %
      <span id="mrongjilv"></span>
    </div>
    <div>
      <span class="w-head">绿化率：</span>
      <input id="lvhualv" name="lvhualv" type="text" style="width:300px;"> %
      <span id="mlvhualv"></span>
    </div>
    <div class="am-form-group">
      <span class="w-head">地铁房：</span>
      <label class="am-radio-inline">
        <input id="ditie_yes" type="radio"  value="是" name="isditie" checked> 是
      </label>
      <label class="am-radio-inline">
        <input id="ditie_no" type="radio" name="isditie" value="否"> 否
      </label>
    </div>
    ...
    <div class="am-form-group">
      ...
      <label class="am-radio-inline">
        <input type="radio"  value="是" name="isxuequ" checked> 是
      </label>
      <label class="am-radio-inline">
        <input type="radio" name="isxuequ" value="否"> 否
      </label>
    </div>
    <div class="am-form-group">
      <span class="w-head">周边医疗：</span>
      <input name="yiliao" type="text" style="width:400px;" placeholder="多个以空格隔开">
    </div>
    <div class="am-form-group">
      <span class="w-head">生活配套：</span>
      <input name="shenghuopeitao" type="text" style="width:400px;" placeholder="多个以空格隔开">
    </div>
    <div class="am-form-group">
      <span class="w-head">交通配置：</span>
      <input name="jiaotong" type="text" style="width:400px;" placeholder="多个以空格隔开">
    </div>
    <div class="am-form-group">
      <span class="w-head">楼盘解说：</span>
      <input name="loupanjieshuo" type="text" style="width:400px;">
    </div>
    <div class="am-form-group forbiaoqian">
      <span class="w-head">标签：</span>
      <input type="checkbox" value="总价低"> 总价低
      <input type="checkbox" value="交通便利"> 交通便利
      <input type="checkbox" value="学区房"> 学区房
      <input type="checkbox" value="高档社区"> 高档社区
    ...
    <div>
      ...
      <input id="contacttel" type="text" name="contacttel" value="{$userinfo.username}">
    ...
    <div>
      ...
      <label class="am-radio-inline">
        <input type="radio" name="hidetel" value="保密"> 保密
      </label>
    </div>
    <div>
    ...
    <input type="hidden" value="经纪人" name="fabulaiyuan">
