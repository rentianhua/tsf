                ...
                <div class="flexbox">
                  ...
                  <div class="item_list">
                    ...
                    <div class="item_minor">
                      <div class="info">{$vo.shi}室{$vo.ting}厅 {$vo.mianji}m²  {$vo.chaoxiang}</div>
                      <div class="price_total q_rentprice">{$vo.zujin}元/月</div>
                    </div>
                    <div class="item_other"><a href="/sz/xiaoqu/2411063416168/" class="location" title="西城品阁.'租房'">{$vo.xiaoqu|getxiaoquName=###}</a></div>
      ...
      <div class="content"> 
        ...
        <div class="filter_item lists_price" data-mark="panel_price">
          <ul class="price_list zj_list">
            ...
            <li class="li" type="zj" value="0-500">500元以下</li>
            <li class="li" type="zj" value="500-1000">500-1000元</li>
            <li class="li" type="zj" value="1000-2000">1000-2000元</li>
            <li class="li" type="zj" value="2000-3000">2000-3000元</li>
            <li class="li" type="zj" value="3000-5000">3000-5000元</li>
            <li class="li" type="zj" value="5000-8000">5000-8000元</li>
            <li class="li" type="zj" value="8000-10000">8000-10000元</li>
            <li class="li" type="zj" value="10000-">10000元以上</li>
          </ul>
        </div>
        <!--/价格--> 
