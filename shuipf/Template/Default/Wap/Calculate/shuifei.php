...
<head>
    ...
    <link href="/statics/taosf/css/calculate_new.css" rel="stylesheet">
    <style>
		#calc1_esf{line-height: 35px;}
		body{font-size: 12px;}
	</style>
    <script src="/statics/taosf/js/jquery-3.1.0.min.js"></script>
...
<body>  
	<p style="padding: 0 10px;font-size: 18px;"><span style="font-weight: bold">税费计算器</span><a style="float: right;font-size:12px;color:#131598" href="/index.php?g=Wap&m=calculate&a=fangdai">房贷计算器>></a></p>
					...
					<div class="mainl">
						...
						<div class="mainltr01">
							<table cellspacing="0" cellpadding="0" border="0">
								<tbody><tr>
									<td>房屋面积：</td>
									<td>
									<input id="housearea" onblur="sfzj(this.form)" class="guestbook01" onkeyup="clearNoNum(this)" type="text"> 平米
									</td>
								</tr>
							</tbody></table>
						</div>
						<div class="mainltr01">
							<table cellspacing="0" cellpadding="0" border="0">
								<tbody><tr>
									<td>房屋单价：</td>
									<td>
									<input id="dj" class="guestbook01" onblur="sfzj(this.form)" onkeyup="clearNoNum(this)" type="text">元/平米
									</td>
								</tr>
							</tbody></table>
						</div>
						...
						<div class="mainltr01" id="housezj">
							<table cellspacing="0" cellpadding="0" border="0">
								<tbody><tr>
									<td>房屋总价：</td>
									<td><input id="houseprice" name="mj3" class="guestbook01" type="text"></td>
									<td>
						...
						<div id="chajia" class="mainltr01" style="display: none;">
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								<tbody><tr>
									<td>房屋原价：</td>
									<td width="18%"><input id="houseyprice" name="mj3" class="guestbook01" type="text"></td>
									<td>
					...
					<div class="mainr">
						...
						<div id="calc1_esf" class="mainrtr01">
							<table cellspacing="0" cellpadding="0" border="0">
								<tbody><tr>
									<td>契 税：</td>
									<td><input id="qishui" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>营 业 税：</td>
									<td><input id="yyshui" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>印 花 税：</td>
									<td><input id="yhshui" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>个人所得税：</td>
									<td><input id="grsdshui" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>工本印花税：</td>
									<td><input id="gbshui" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>综合地价款：</td>
									<td><input id="zhdijikuai" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>合 计：</td>
									<td><input id="heji" class="guestbook01" readonly="" type="text">元</td>
								</tr>
							</tbody></table>
						</div>
						...
						<div class="mainrtr01" id="calc1_xf" style="display: none;">
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								<tbody><tr>
									<td width="11%">房款总款：</td>
									<td width="53%"><input id="fkz3" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>印 花 税：</td>
									<td><input id="yh" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>公 证 费：</td>
									<td><input id="gzh" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>契&#12288;&#12288;税：</td>
									<td><input id="q" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>委托办理产权手续费：</td>
									<td><input id="wt" class="guestbook01" readonly="" type="text">元</td>
								</tr>
								<tr>
									<td>房屋买卖手续费：</td>
									<td><input id="fw" class="guestbook01" readonly="" type="text">元</td>
								</tr>
							</tbody></table>
						</div>
