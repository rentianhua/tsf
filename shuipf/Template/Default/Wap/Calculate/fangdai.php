...
<p style="padding: 0 10px;font-size: 18px;"><span style="font-weight: bold">房贷计算器</span><a style="float: right;font-size:12px;color:#131598" href="/index.php?g=Wap&m=calculate&a=shuifei">税费计算器>></a></p>    
<div id="calculate01" >
				...
				<td valign="top">
					<div class="mainl">
						...
						<div id="calc11_ctype" class="calculator" style="padding: 5px 0 10px 20px">
							...
							<ul>
								<li style="line-height: 30px; " class="cnradio">
								...
								<span id="calc1_js_div1" style="display: block">
									<li style="line-height: 30px; ">&nbsp;&nbsp;&nbsp;&nbsp;单价：<input id="price" name="price" type="text" class="guestbook01" />元/平米</li>
									<li style="line-height: 30px; ">&nbsp;&nbsp;&nbsp;&nbsp;面积：<input id="sqm" name="sqm" type="text" class="guestbook01" />平方米</li>
									<li style="line-height: 30px; ">&nbsp;&nbsp;&nbsp;&nbsp;按揭成数：
...
<option value="35" >12年6月8日基准利率</option>
						...
						<div class="mainltr01 cnradio">还款方式：<input id="dengeben1" type="radio" name="radioben" value="1" checked onclick="ext_loanbenjin(this.form, this.value)" />
							...
							等额本金</div>
						<div class="mainltr02">
							<input type="button" onclick="ext_loantotal(document.calc11)" value="计算购房贷款">
							  &nbsp;&nbsp;
						<input type="button" onclick="loanreset(document.calc11);" value="重新填写贷款条件">
						</div>
					</div>
				</td>				
			</tr>
					...
					<div class="mainr">
						...
						<div class="mainrtr01">
							<ul>
								...
								<li>支付利息：<input name="accrual1" type="text" class="guestbook02" readonly />元</li>
							...
							<div class="mainrtr01tr" style="text-align: right; padding-right: 50px;">*以上结果仅供参考 </div>
						</div>
					</div>
				</td>
			</tr>
